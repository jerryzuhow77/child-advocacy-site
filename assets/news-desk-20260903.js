(() => {
  ...
  const reports = {
    ...
    dailyBrief20260907: { date:'2026-09-07', priority:0, publisher:{'zh-Hant':'每日護童總報','zh-Hans':'每日护童总报',en:'Daily Child Protection Brief',ja:'子ども保護デイリーブリーフ'}, title:{'zh-Hant':'早期警訊，如何真正啟動保護？','zh-Hans':'早期警讯，如何真正启动保护？',en:'How should early warnings trigger protection?',ja:'早期警告を、どう保護につなげるか'}, summary:{'zh-Hant':'少年保護程序、兒虐致死未曾通報問題、責任通報制度與可稽核早期保護門檻。','zh-Hans':'少年保护程序、未曾通报问题与可核查的早期保护门槛。',en:'Juvenile protection procedure, unreported fatal abuse cases and auditable early-intervention thresholds.',ja:'少年保護手続、通報されなかった重大事案、監査可能な早期介入基準。'}, article:{'zh-Hant':`${ROOT}news/daily-child-protection-brief-20260907/`,'zh-Hans':`${ROOT}news/daily-child-protection-brief-20260907/zh-Hans/`,en:`${ROOT}en/news/daily-child-protection-brief-20260907/`,ja:`${ROOT}ja/news/daily-child-protection-brief-20260907/`}, source:'https://cons.judicial.gov.tw/docdata.aspx?fid=38&id=358150', image:`${ROOT}assets/images/daily-child-protection-brief-paper-clay-20260907.webp`, alt:{'zh-Hant':'守護兒少、早期警訊與保護門檻的紙雕陶土藝術意象','zh-Hans':'守护儿童、早期警讯与保护门槛的纸雕陶土艺术意象',en:'Paper-and-clay artwork symbolising early warnings and child-protection thresholds',ja:'早期警告と子ども保護基準を象徴する紙彫刻と粘土のアート'} },
