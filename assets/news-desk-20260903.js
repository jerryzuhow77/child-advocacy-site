(() => {
  ...
  const reports = {
    dailyBrief: { date:'2026-09-07', priority:-1, publisher:{'zh-Hant':'每日護童總報','zh-Hans':'每日护童总报',en:'Daily Child Protection Brief',ja:'子ども保護デイリーブリーフ'}, title:{'zh-Hant':'早期警訊，如何真正啟動保護？','zh-Hans':'早期警讯，如何真正启动保护？',en:'How should early warnings trigger protection?',ja:'早期警告を、どう保護につなげるか'}, summary:{'zh-Hant':'少年保護程序、兒虐死亡未曾通報問題，以及不依賴個別承辦人直覺的可稽核門檻。','zh-Hans':'少年保护程序、虐待死亡未曾通报问题，以及不依赖个别承办人直觉的可核查门槛。',en:'Juvenile protection procedure, unreported fatal abuse cases and auditable early-intervention thresholds.',ja:'少年保護手続、未通報の重大事案、監査可能な早期介入基準。'}, article:{'zh-Hant':`${ROOT}news/daily-child-protection-brief-20260907/`,'zh-Hans':`${ROOT}news/daily-child-protection-brief-20260907/zh-Hans/`,en:`${ROOT}en/news/daily-child-protection-brief-20260907/`,ja:`${ROOT}ja/news/daily-child-protection-brief-20260907/`}, source:'https://cons.judicial.gov.tw/docdata.aspx?fid=38&id=358150', image:`${ROOT}assets/images/daily-child-protection-brief-paper-clay-20260907.webp`, alt:{'zh-Hant':'紙雕山景、陶土守護屋、警訊漣漪與安全網的象徵藝術','zh-Hans':'纸雕山景、陶土守护屋、警讯涟漪与安全网的象征艺术',en:'Symbolic paper landscape, clay shelter, warning ripples and safety net',ja:'紙彫刻の山、粘土の保護シェルター、警告の波紋、安全網'} },
