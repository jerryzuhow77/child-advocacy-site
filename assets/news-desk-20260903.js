(() => {
  ...
  const reports = {
    dailyBrief20260918: {date:'2026-09-18',priority:-20,languages:['zh-Hant'],publisher:{'zh-Hant':'每日護童快報'},title:{'zh-Hant':'剴剴案定讞後：把悲劇化為可稽核的保護'},summary:{'zh-Hant':'分開閱讀定讞案件與仍在上訴的案件；讓責任、程序與制度改革各自清楚。'},article:{'zh-Hant':`${ROOT}news/daily-child-protection-brief-20260918/`},source:'https://www.cna.com.tw/news/asoc/202607230185.aspx',image:`${ROOT}assets/art/child-protection-brief-embroidery-ink-20260917-zh-Hant.svg`,credit:{'zh-Hant':'秋日繡藝水墨守護意象，非事件現場'},alt:{'zh-Hant':'秋日繡藝水墨守護意象'}},
