(() => {
  ...
  const copy = {
    'zh-Hant': {
      ...
      art: '莫蘭迪粉嫩色紙雕層景、訪視紀錄與象徵剴剴的陶土孩童藝術意象，搭配林心慈出庭資料照片',
    ...
    'zh-Hans': {
      ...
      art: '莫兰迪粉嫩色纸雕层景、访视记录与陶土儿童艺术意象，搭配林心慈出庭资料照片',
    ...
    en: {
      ...
      art: 'Morandi paper-cut layers, visit records and a clay child sculpture, paired with a file photograph of Lin Hsin-tzu',
    ...
    ja: {
      ...
      art: 'モランディ調の紙彫刻、訪問記録、粘土の子どもの造形と、林心慈氏の出廷資料写真',
  ...
  function assetRoot() {
    ...
    return { css: new URL('home-media-reports-20260903.css?v=20260903-2', script).href, art: new URL('images/news-desk-paper-clay-hero-20260903.svg', script).href };
  }
