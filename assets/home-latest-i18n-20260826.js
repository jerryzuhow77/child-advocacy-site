(function () {
  ...
  var copy = {
    en: {
      ...
      intro: 'Four pinned reports support automatic looping and manual horizontal movement, while the 10 most recently published articles move gently around the children’s Ferris wheel.',
      all: 'View all documents →', pinned: 'Pinned reports', pinnedHint: 'Four important updates can loop automatically or move manually',
    ...
    ja: {
      ...
      intro: '4件の固定速報は自動循環と手動の横移動に対応し、最新公開10件の記事が子どもらしい観覧車に乗ってゆっくり回ります。',
      all: '資料一覧を見る →', pinned: '固定速報', pinnedHint: '重要な4件を自動循環または手動で横移動',
