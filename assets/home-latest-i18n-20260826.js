(function () {
  ...
  var sharedPinned = [
    { className:'is-audit-20260908', href:localizedPath('news/early-warning-audit-20260908/'), image:local('assets/art/early-warning-audit-20260908.webp') },
  ...
  var copy = {
    en: {
      ...
      intro: 'Five pinned reports support automatic looping and manual horizontal movement, while the 10 most recently published articles move gently around the children’s Ferris wheel.',
      all: 'View all documents →', pinned: 'Pinned reports', pinnedHint: 'Five important updates can loop automatically or move manually',
      ...
      pinnedItems: [
        {"meta": "09.08 · AUDIT · PINNED", "title": "Beyond 70%: bringing early warnings into protection", "summary": "Read the numbers carefully. Then ask how protection actually reaches a child.", "alt": "AI ink-wash illustration: lotus leaves sheltering new buds. Not an event photograph or an original Qi Baishi painting."},
    ...
    ja: {
      ...
      intro: '5件の固定速報は自動循環と手動の横移動に対応し、最新公開10件の記事が子どもらしい観覧車に乗ってゆっくり回ります。',
      all: '資料一覧を見る →', pinned: '固定速報', pinnedHint: '重要な5件を自動循環または手動で横移動',
      ...
      pinnedItems: [
        {"meta": "09.08・審計資料・固定", "title": "「約7割」の先へ：早期の兆候を保護につなぐ", "summary": "数字を正確に読み、保護が子どもに届くまでを問い直す。", "alt": "AI水墨イメージ：若い芽を守る蓮の葉。現場写真でも、斉白石の原画でもありません。"},
