...
const chapters=[
 ...
 <div class="qa"><div><b>檢察官</b>妳看A童站2、3小時，是否有帶他離開？Mira筆錄稱A童經常沒穿衣服整天罰站，也曾由妳幫忙照顧。</div><div><b>劉若琳</b>我沒叫A罰站，不知Mira為何如此說。</div></div>
...
document.querySelector('#recordList').innerHTML=chapters.map((x,i)=>`<details ${i===0?'open':''}><summary>${x.title}</summary><div class="record-content">${x.html}</div></details>`).join('');
