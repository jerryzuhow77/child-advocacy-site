...
const copy={"loading":"量刑弁論の全文を読み込み中…","shown":"節を表示","empty":"一致する節はありません。","failed":"全文を読み込めませんでした。上の原文リンクをご利用ください。","search":"検索","titles":["検察官の量刑弁論","国民法官の質問と午前の手続","劉彩萱側の量刑弁論","検察官の説明","劉若琳側の量刑弁論","検察官の補充弁論","劉彩萱側の補充弁論・ウェブ補遺","劉若琳側の補充弁論","二人の被告の最終陳述","訴訟参加代理人・審理終了"],"labels":["検察官","裁判所・裁判長","劉彩萱の弁護人","劉若琳の弁護人","弁護人","被告劉彩萱","被告劉若琳","訴訟参加代理人"],"supplement":{"label":"ウェブ原文補遺","speaker":"劉彩萱の弁護人","text":"1．台湾新北地方法院109年度訴字第137号刑事判決：幼児の発育を妨げる虐待致死罪、無期懲役、公権終身剥奪。事件の事実関係は大きく異なり、処罰は比例にかなわなければなりません。","boundary":"この部分は監所関注小組のウェブ原文にあり、保存された7ページPDFにはありません。翻訳して独立の補遺として掲載し、PDF文字レイヤーとは表示しません。","link":"原ページを見る ↗"}};
