(function () {
  ...
  document.querySelectorAll('.chapter-nav a,.responsibility-step,.evidence-card,.evidence-step,.lens,.risk-cell,.law-card,.news-card,.appeal-card,.note,.source-calibration,.info-chain-step,.not-equal,.legal-layer,.legal-path article,.legal-question,.record-field,.implementation-card').forEach(function (card) {
